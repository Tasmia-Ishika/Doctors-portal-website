    ...
    return (
        <div className="card lg:max-w-lg  bg-base-100 shadow-xl">
            <div className="card-body m-3 p-6">
                ...
                <p className='text-center font-semibold text-xl'>${price}</p>

                <p className='text-center font-bold'>{slots.length} {slots.length > 1 ? 'Slots' : 'Slot'} Available</p>
                <div className="card-actions justify-center">
                    <label htmlFor="booking-modal" disabled={slots.length === 0} onClick={() => setTreatment(service)} className="btn btn-secondary bg-gradient-to-r from-secondary to-primary text-white font-bold mt-2 btn-sm uppercase">Book Appointment</label>
